        ...
        <div class="max-w-3xl mx-auto">
            <form @submit.prevent="submit">
                ...
                <CardHeader class="border-b border-border/80">
                    ...
                    <CardDescription class="text-xs text-muted-foreground mt-0.5">Ubah nama role atau sesuaikan hak aksesnya.</CardDescription>
                </CardHeader>
                        <CardContent class="space-y-4">
                            <div class="grid gap-1.5">
                                ...
                                <p v-if="role.name === 'super-admin'" class="text-[11px] text-amber-600">Nama role super-admin tidak dapat diubah.</p>
                            </div>
