        ...
        <div class="max-w-4xl mx-auto bg-white text-black p-8 sm:p-12 shadow-md rounded-xl print:shadow-none print:rounded-none print:w-full print:max-w-none font-sans min-h-[1000px] flex flex-col justify-between">
            <div>
                ...
                <div class="text-center my-8">
                    <h2 class="text-base font-bold uppercase tracking-wider">VERIFIKASI KELENGKAPAN DAN KEABSAHAN</h2>
                </div>

                <!-- IDENTITY SECTION -->
                <div class="text-sm space-y-2 mb-8 px-2">
                    <div class="flex">
                ...
                <!-- STATEMENT BODY -->
                <div class="text-sm space-y-6 text-justify leading-relaxed px-2">
                    <p>
            ...
            <!-- SIGNATURE SECTION -->
            <div class="flex justify-end text-sm mt-16 px-4">
