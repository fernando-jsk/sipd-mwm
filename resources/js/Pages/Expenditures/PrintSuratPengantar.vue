    ...
    <div class="min-h-screen bg-slate-100 dark:bg-slate-900 p-4 sm:p-8 print:bg-white print:p-0 print:m-0">
        ...
        <div class="max-w-4xl mx-auto bg-white text-black p-6 sm:p-10 shadow-md rounded-xl font-sans print:shadow-none print:rounded-none print:w-full print:max-w-none print:p-0 print:m-0">
            ...
            <div class="text-center mb-3">
                ...
                <h2 class="text-xs font-bold uppercase mt-2 tracking-wide underline">SURAT PENGANTAR</h2>
            </div>

            <!-- RECIPIENT -->
            <div class="text-[10px] mb-3 space-y-0.5">
                <p>Kepada Yth.</p>
                <p class="font-semibold">Pengguna anggaran / kuasa pengguna anggaran</p>
                <p>SKPD BLUD RSUD Maria Walanda Maramis</p>
                <p>Di tempat</p>
            </div>

            <!-- CONTENT LIST -->
            <div class="text-[10px] space-y-2 mb-6">
                <div class="flex">
                    <div class="w-56 font-semibold">a. Urusan Permintaan</div>
                    <div class="w-4">:</div>
                    <div class="flex-1">1.02 Urusan Wajib Pelayanan Dasar Kesehatan</div>
                </div>

                <div class="flex">
                    <div class="w-56 font-semibold">b. SKPD</div>
                    <div class="w-4">:</div>
                    <div class="flex-1">1.02.02.01 BLUD RSUD Maria Walanda Maramis</div>
                </div>

                <div class="flex">
                    <div class="w-56 font-semibold">c. Tahun Anggaran</div>
                    <div class="w-4">:</div>
                    <div class="flex-1">{{ expenditure.date ? new Date(expenditure.date).getFullYear() : '-' }}</div>
                </div>

                <div class="flex">
                    <div class="w-56 font-semibold">d. Dasar pengeluaran SPD Nomor</div>
                    <div class="w-4">:</div>
                ...
                <div class="flex flex-col space-y-0.5">
                    <div class="flex">
                        <div class="w-56 font-semibold">e. Jumlah sisa dana</div>
                        <div class="w-4">:</div>
                        <div class="flex-1 font-bold font-mono">Rp. {{ formatCurrency(totalDpa || 0) }}</div>
                    </div>
                    <div class="pl-60 italic capitalize text-muted-foreground text-[9.5px]">
                        {{ terbilang(totalDpa || 0) }} Rupiah
                    </div>
                </div>

                <div class="flex">
                    <div class="w-56 font-semibold">f. Nama Bendahara Pengeluaran</div>
                    <div class="w-4">:</div>
                ...
                <div class="flex flex-col space-y-0.5">
                    <div class="flex">
                        <div class="w-56 font-semibold">g. Jumlah Pembayaran yang Diminta</div>
                        <div class="w-4">:</div>
            ...
            <!-- SIGNATURES -->
            <div class="flex justify-between text-[10px] mt-6 px-6 print:break-inside-avoid">
                <div class="w-64 flex flex-col items-center">
                    <p class="mb-12 font-semibold">PEJABAT PELAKSANA TEKNIS KEGIATAN</p>
                ...
                <div class="w-64 flex flex-col items-center">
                    ...
                    <p class="mb-12 font-semibold">BENDAHARA PENGELUARAN</p>
