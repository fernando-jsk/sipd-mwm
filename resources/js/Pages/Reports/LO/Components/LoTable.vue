            ...
            <table class="w-full text-sm text-left">
                <thead class="text-xs text-muted-foreground uppercase bg-muted/30 border-b border-border">
                    <tr>
                        ...
                        <th class="px-4 py-3 font-medium text-right w-1/4">Jumlah (Rp)</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <template v-else>
                        <tr 
                            ...
                            :class="{
                                'bg-muted/10 font-semibold text-foreground': row.level <= 2,
                                'font-medium text-foreground': row.level === 3,
